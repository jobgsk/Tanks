...
namespace aicore
{
    ...
    struct SteeringOutput
    {
         ...
         * SteeringOutput.
         */
        SteeringOutput(const Vector3<float> & linear, float angular = 0)
    ...
    struct Location
    {
         ...
         */
        Location(const Vector3<float> & position)
         ...
         */
        Location(const Vector3<float> & position, float orientation)
         ...
         */
        void setOrientationFromVelocity(const Vector3<float> & velocity);

        /**
         * Returns a unit vector in the direction of the current
         * orientation.
         */
        Vector3<float>  getOrientationAsVector() const;
    ...
    struct Kinematic : public Location
    {
         ...
         */
        Kinematic(const Vector3<float> & position, const Vector3<float> & velocity)
         ...
         * @param velocity The linear velocity of the Kinematic.
         */
        Kinematic(const Location& loc, const Vector3<float> & velocity)
         ...
         */
        Kinematic(const Vector3<float> & position, float orientation,
                  const Vector3<float> & velocity, float avel)
