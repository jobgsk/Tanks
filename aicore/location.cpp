...
namespace aicore
{
    ...
    void Location::setOrientationFromVelocity(const Vector3<float>& velocity)
    {
    ...
    Vector3<float> Location::getOrientationAsVector() const
    {
        return Vector3<float>(real_sin(orientation),
                       0,
